    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "paid_leave_supp_frac_month_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mam",
                    models.DecimalField(decimal_places=2, default=1400, max_digits=6),
                ),
                (
                    "total",
                    models.DecimalField(
                ...
                (
                    "cost",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="salaire.cost"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="salaire.month"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "factor",
                    models.DecimalField(decimal_places=2, default=80, max_digits=10),
                ),
                (
                    "salary",
                    models.DecimalField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="salaire.pricing"
            ),
        ),
    ]
